package com.genepoint.common.utils;
...
public class PositionConvertUtil {
	...
	public static boolean loadConverters(String cfgPath, String convertDir) throws Exception {
		...
		try {
			...
			logger.info("PositionConvertUtil: converter="+list.toString());
	...
	/*public static void main(String[] args) {
		try {
			...
			for (int i = 0; i < 1000000; i++) {
				double[] res = PositionConvertUtil.convert("1102588", 10, 10);
			}
...
class Converter {
	...
	public String toString() {
		return "Converter [building=" + building + ", classPath=" + classPath + "]";
	}
