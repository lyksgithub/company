...
<script src="<%=basePath%>/static/script/jquery-ui/jquery-ui.min.js"></script>
...
<script src="<%=basePath%>/static/assets/js/tooltip.js"></script>
<script src="<%=basePath%>/static/script/common/security.js"></script>
</body>
</html>
