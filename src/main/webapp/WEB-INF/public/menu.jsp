  ...
  <div class="admin-sidebar">
    <ul class="am-list admin-sidebar-list">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="info-center">
          <li id="home"><a href="<%=basePath%>/home.jsp"><span class="am-icon-home"></span> 客流总览</a></li>
            <li id="real_heatmap"><a href="<%=basePath%>/real_heatmap.jsp"><span class="am-icon-area-chart"></span>实时热力图</a></li>          
          <li id="customer_realtime"><a href="<%=basePath%>/customer.jsp"><span class="am-icon-area-chart"></span> 实时客流分布</a></li>
         <li id="ap_realtime"><a href="<%=basePath%>/ap.jsp"><span class="am-icon-database"></span> AP工作状态</a></li>
         </ul>
      </li>
      <!--  
      <li class="admin-parent">
      ...
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-track">
          <li id="gailan"><a href="<%=basePath%>/gailan.jsp"><span class="am-icon-area-chart"></span> 概览</a></li>
          <li id="heatmap_history"><a href="<%=basePath%>/heatmap.jsp"><span class="am-icon-area-chart"></span> 历史热力图</a></li>
            <li id="customertrack"><a href="<%=basePath%>/customertrack.jsp"><span class="am-icon-area-chart"></span> 多人轨迹图</a></li>
          <li id="track_one"><a href="<%=basePath%>/track.jsp"><span class="am-icon-database"></span> 单人轨迹</a></li>
       </ul>
      </li>
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-shop">
          <li id="shop"><a href="<%=basePath%>/shop.jsp"><span class="am-icon-building"></span> 到店分析</a></li>
          <li id="shop_bi"><a href="<%=basePath%>/userPortrait.jsp"><span class="am-icon-building"></span> 客户属性</a></li>
          <li id="shop_activity"><a href="<%=basePath%>/shop.jsp"><span class="am-icon-building"></span> 营销活动</a></li>
        </ul>
      </li>
