...
<div class="am-cf admin-main">
  ...
  <div class="admin-content" style="min-height:800px;height:800px;">
    <div class="am-cf am-padding am-u-sm-12" style="height:800px;overflow:auto">
    	<div id="realtime_customer_count" style="width: 100%;height:500px;text-align: center;margin-left: auto;margin-right: auto;"></div>
    	<div id="realtime_customer_line" style="float:left;width:100%;height:500px;clear:both"></div>
    	<!-- <div id="shop_list">
